...
def her_classifer(filepath):
    ...
    gcn_model.load_state_dict(torch.load('models/para/gcn_her.pth'))
    ...
    rnn_model.load_state_dict(torch.load('models/para/rnn_her.pth'))
    ...
    DCAN_model.load_state_dict(torch.load('models/para/dcan_her.pth'))
