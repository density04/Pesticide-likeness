...
def fun_classifer(filepath):
    ...
    gcn_model.load_state_dict(torch.load('models/para/gcn_fun.pth'))
    ...
    rnn_model.load_state_dict(torch.load('models/para/rnn_fun.pth'))
    ...
    DCAN_model.load_state_dict(torch.load('models/para/dcan_fun.pth'))
